...
<template>
   <div class="goodsList">
      <el-table
         ...
         <el-table-column label="头像" prop="userImg" width=140>
         ...
         <el-table-column label="注册时间" prop="time"> 
            <template slot-scope="scope" width="100">
               <p >{{scope.row.time?"有时间":"尚未填写时间"}}</p>
            </template> 

         </el-table-column>
         <el-table-column label="性别" prop="userSex">
            <template slot-scope="scope">
               {{scope.row.userImg?"男":"女"}}
            </template>
          </el-table-column>
         <el-table-column label="是否删除" prop="deleteTag">
            <template slot-scope="scope" width="100">
         ...
         <el-table-column align="right" >
            ...
            <template slot-scope="scope">
               <el-button type="primary" icon="el-icon-edit" circle size="mini">查看喜好</el-button>
               <el-button
                  size="mini"
                  @click="handleInterest(scope.$index, scope.row)"
                  plain
                  >查看喜好</el-button
               >
      ...
      <div style="margin:35px;font-size: 17px;">
         <div>
            <img :src="newData.userImg" alt="" style="width:80px;height:80px">
         </div>
         <br>
         <div>
         ...
         <div>
            <div style="margin-bottom:10px">
               ...
               <el-input v-model="newData.userName" placeholder="请输入内容" style="width:260px"></el-input>
         </div>
         <br>
         <div>
            <el-switch
      ...
      handleClose(done) {
         ...
         this.$confirm("确定要提交表单吗？")
            .then((_) => {
               ...
               //更新用户信息
               this.$axios({
                  url: "/api/user/backstageupdatabyid",
                  method: "post",
                  headers: {
