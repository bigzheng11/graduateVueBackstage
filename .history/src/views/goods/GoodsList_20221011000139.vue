      ...
      handleClose(done) {
         ...
         this.$confirm("确定要提交表单吗？")
            .then((_) => {
               ...
               console.log(typeof this.newData.goodsClassify); //object
               console.log(Object.keys(this.newData.goodsClassify)); //object

               if(typeof this.newData.goodsClassify===objec)

               console.log("内部数据", typeof this.newData.goodsClassify[0]); //object
               //修改商品信息
               this.$axios({
