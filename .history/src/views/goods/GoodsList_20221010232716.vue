...
export default {
   ...
   methods: {
      ...
      test() {
         this.newData.goodsID = 17;
         this.newData.goodsName = "WW";
         this.newData.goodsDescribe = "SS";
         this.newData.goodsClassify = 1;
         this.newData.price = 22;

         // this.$axios
         //    .post("/api/goods/backstageUpdataById", {
         ...
         this.$axios({
            ...
            method: "post",
            data: { 
               goodsID: this.newData.goodsID
               goodsName: this.newData.goodsName
               goodsDescribe: this.newData.goodsDescribe
               goodsClassify: this.newData.goodsClassify
               price: this.newData.goodsID
             },
            headers: {
               "Access-Control-Allow-Origin": "*",
            },
      ...
      handleClose(done) {
         ...
         this.$confirm("确定要提交表单吗？")
            .then((_) => {
               ...
               // this.$axios
               //    .post(
               //       "goods/backstageUpdataById" +
               //          this.$qs.stringify(this.newData)
               //    )
               //    .then((response) => {
               ...
               axios
                  .post("goods/backstageUpdataById", {
                     params: this.newData,
                     headers: {
                        //头部参数
                        "Access-Control-Allow-Origin": "*",
