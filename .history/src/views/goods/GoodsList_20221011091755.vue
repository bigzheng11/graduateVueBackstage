   ...
   <div class="goodsList">
      <el-table
         ...
         <el-table-column label="是否删除" prop="deleteTag"><template slot-scope="scope" width="100">
               <p :class="scope.row.deleteTag?'':'red'" v-show="scope.row.deleteTag">{{scope.row.deleteTag?"未删":"已经删除"}}</p>

               <el-tag type="danger" v-if="!scope.row.deleteTag" disable-transitions="f">{{scope.row.deleteTag?"未删":"已经删除"}}</el-tag>
